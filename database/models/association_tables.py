from sqlalchemy import ForeignKeyConstraint, Integer, String, Table, Column, PrimaryKeyConstraint, Uuid, Boolean, DateTime, Text, Identity, text, UniqueConstraint
...
t_media_keyword = Table(
    ...
    ForeignKeyConstraint(['movie_id'], ['movie.id'], name='media_keyword_movie_id_fkey', ondelete='CASCADE'),
)

# replaced with movie_translation and later with tv_translation
...
t_media_production_company = Table(
    ...
    ForeignKeyConstraint(['movie_id'], ['movie.id'], name='media_production_company_movie_id_fkey', ondelete='CASCADE'),
    ForeignKeyConstraint(['tv_id'], ['tv.id'], name='media_production_company_tv_id_fkey', ondelete='CASCADE')
)
...
t_media_production_country = Table(
    ...
    ForeignKeyConstraint(['movie_id'], ['movie.id'], name='media_production_country_movie_id_fkey', ondelete='CASCADE'),
    ForeignKeyConstraint(['tv_id'], ['tv.id'], name='media_production_country_tv_id_fkey', ondelete='CASCADE')
)
...
t_movie_movie_genre = Table(
    ...
    ForeignKeyConstraint(['movie_id'], ['movie.id'], name='movie_movie_genre_movie_id_fkey', ondelete='CASCADE'),
...
t_credit = Table(
    ...
    ForeignKeyConstraint(['movie_id'], ['movie.id'], name='credit_movie_id_fkey', ondelete='CASCADE'),
...
t_playlist_media = Table(
    ...
    ForeignKeyConstraint(['movie_id'], ['movie.id'], name='playlist_media_movie_id_fkey', ondelete='CASCADE'),
    ForeignKeyConstraint(['playlist_id'], ['playlist.id'], name='playlist_media_playlist_id_fkey', ondelete='CASCADE'),
    ForeignKeyConstraint(['tv_id'], ['tv.id'], name='playlist_media_tv_id_fkey', ondelete='CASCADE')
)
