...
EMOTION_GENRE_MAPPING: Dict[Emotion, List[int]] = {
    ...
    Emotion.ADRENALINE:     [12, 28, 10752, 37, 878, 53],        # Aventure, Action, Guerre, Western, Science-Fiction, Thriller
    ...
    Emotion.REFLEXION:      [99, 18, 9648, 36, 878],             # Documentaire, Drame, Mystère, Histoire, Science-Fiction
    Emotion.NOSTALGIE:      [36, 10751, 37, 10402, 16, 10770, 18] # Histoire, Familial, Western, Musique, Animation, Téléfilm, Drame
}
